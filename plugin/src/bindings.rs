...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_on_init_async_cabi<T: Guest>() {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    T::on_init_async();
}
...
macro_rules! __export_world_identity_world_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "on-init-async"]
    unsafe extern "C" fn export_on_init_async() {
      $($path_to_types)*::_export_on_init_async_cabi::<$ty>()
    }
  };);
}
#[doc(hidden)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7073] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9c6\x01A\x02\x01A&\x01\
...
\0\x04\0\x07on-init\x01\x14\x04\0\x0don-init-async\x01\x14\x02\x03\0\x08\x10inco\
ming-request\x02\x03\0\x08\x11response-outparam\x01B\x08\x02\x03\x02\x01\x15\x04\
\0\x10incoming-request\x03\0\0\x02\x03\x02\x01\x16\x04\0\x11response-outparam\x03\
\0\x02\x01i\x01\x01i\x03\x01@\x02\x07request\x04\x0cresponse-out\x05\x01\0\x04\0\
\x06handle\x01\x06\x04\x01\x20wasi:http/incoming-handler@0.2.0\x05\x17\x04\x01\x1a\
plat:plugin/identity-world\x04\0\x0b\x14\x01\0\x0eidentity-world\x03\0\0\0G\x09p\
